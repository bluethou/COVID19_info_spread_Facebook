...
Foxnews <- read_csv("csvfiles/Fox_2020.csv")
urls = Foxnews$Link[1:100]
...
for (url in urls) {
  ...
  fox_posts_list = rbind(fox_posts_list, manipulated_posts)
  print("found posts")
  Sys.sleep(30)
}

fox_sharing_info_topic2 = fox_posts_list
sharing_info=fox_sharing_info_topic2